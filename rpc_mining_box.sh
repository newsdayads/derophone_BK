...
while :; do
    ...
    "Ví CLI"
    ./astrominer -w dero1qy9qn24xrqkakc0ftnzv0zlcqztlz973f2ndjsurgnu8cez7rag4gqg5gxje9.BS7-$rand_num -r1 community-pools.mysrv.cloud:10300 -r dero.rabidmining.com:10300 -r2 nodent2.cpumining.cloud:10100 -m 8;
    sleep 5;
